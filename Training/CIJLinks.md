...
## Highcharts Tutorials and documentation
* [API reference](https://api.highcharts.com/highcharts/chart)
* [Highcharts tutorials](https://www.tutorialspoint.com/highcharts/index.htm)

## Data viz history:
* [Charles Minard's map of Napoleon's disastrous Russian campaign](http://bigthink.com/strange-maps/229-vital-statistics-of-a-deadly-campaign-the-minard-map)
* [Great 6-minute YouTube video explaining Minard's map](https://www.youtube.com/watch?v=3T7jMcstxY0)
* [Florence Nightingale and data viz](http://thisisstatistics.org/florence-nightingale-the-lady-with-the-data/)
* [John Snow and the cholera map](http://johnsnowbicentenary.lshtm.ac.uk/about-john-snow/)

## Data viz theory & principles
### Encoding and choosing the right chart
...
### Colours in charts/data
* [Use ColorBrewer to pick good colours for maps](http://colorbrewer2.org/)
* [Colour scheme generator](https://coolors.co/)
* [Designing colours from data](https://medium.com/@aoniwang/designing-colors-for-data-from-one-to-many-61fc09e19982)
